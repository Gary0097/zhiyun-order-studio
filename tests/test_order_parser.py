...
class OrderParserTests(unittest.TestCase):
    def test_complete_chinese_order_is_extracted(self) -> None:
        result = parse_order_text("订单号：PO-20260822-01；下单日期：2026年8月22日；客户：海川制造；产品：伺服电机；数量：20台；交期：2026年9月10日")
        self.assertEqual(result["order"]["order_no"], "PO-20260822-01")
        ...
        self.assertEqual(result["order"]["order_date"], "2026-08-22")
